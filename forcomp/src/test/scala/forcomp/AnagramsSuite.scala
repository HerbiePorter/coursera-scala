...
class AnagramsSuite extends FunSuite {
  ...
  test("sentenceOccurrences: abcde e") {
    assert(sentenceOccurrences(List("abcde", "e")) === List(('a', 1), ('b', 1), ('c', 1), ('d', 1), ('e', 2)))
  }

  test("sentenceOccurrences: abcde a b c c") {
    assert(sentenceOccurrences(List("edcba", "a", "b", "c", "c")) === List(('a', 2), ('b', 2), ('c', 3), ('d', 1), ('e', 1)))
  }
  ...
  test("sentence anagrams: a cat") {
    val sentence = List("at", "cat")
    val anas = List(
      List("cat", "at"),
      List("at", "cat"),
      List("act", "at"),
